...
export default function ContactForm() {
  ...
  return (
    <div className="flex items-center min-h-screen bg-gray-100 relative"
    style={{
    ...
    <div className="w-full md:w-1/2 text-center md:text-left mb-8 md:mb-0">
          <h4 className="text-2xl mt-40 sm:text-4xl md:text-5xl font-bold text-white mb-6">
            Consultionat, <br />
            Design, & Marketing
            <p className="text-white">We offer expert consultation, creative design, and strategic  <br />
          marketing to 
          <br /> your brand and success.</p>
          </h4>
      ...
      <div className="bg-blue-900 p-6 rounded-lg shadow-md w-full max-w-md">
        ...
        <form >
          ...
          <div className="mb-4">
            <label htmlFor="areaCity" className="block text-sm font-medium text-white">
              Area, City
            </label>
            <input
              type="text"
